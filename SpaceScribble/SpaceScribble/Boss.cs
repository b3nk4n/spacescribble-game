...
namespace SpaceScribble
{
    class Boss : ILevel
    {
        ...
        private const int BossRadiusEasy = 36;
        private const int BossRadiusMedium = 36;
        ...
        private const float InitialHitPointsMedium = 2250.0f;
        private const float InitialHitPointsHard = 2500.0f;
        private const float InitialHitPointsSpeeder = 2000.0f;
        private const float InitialHitPointsTank = 2750.0f;
