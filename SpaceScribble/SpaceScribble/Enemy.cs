...
namespace SpaceScribble
{
    class Enemy : ILevel
    {
        ...
        private const int EnemyRadiusEasy = 18;
        ...
        private const float InitialHitPointsEasy = 50.0f;
        private const float InitialHitPointsMedium = 75.0f;
        private const float InitialHitPointsHard = 100.0f;
        private const float InitialHitPointsSpeeder = 75.0f;
        private const float InitialHitPointsTank = 150.0f;
        ...
        private readonly Rectangle HardSource = new Rectangle(350, 150,
                                                              50, 50);
        private readonly Rectangle SpeederSource = new Rectangle(350, 200,
                                                                 50, 50);
